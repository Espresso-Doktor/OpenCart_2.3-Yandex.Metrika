	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('analytics_metrika', $this->request->post, $this->request->get['store_id']);
		...
		if (isset($this->request->post['yandex_metrika_code'])) {		
			...
			$data['yandex_metrika_code'] = $this->model_setting_setting->getSettingValue('yandex_metrika_code', $this->request->get['store_id']);
		}

		if (isset($this->request->post['yandex_metrika_status'])) {
			$data['yandex_metrika_status'] = $this->request->post['yandex_metrika_status'];
		} else {
			$data['yandex_metrika_status'] = $this->model_setting_setting->getSettingValue('yandex_metrika_status', $this->request->get['store_id']);
		}
